...
const Group3 = {
    dom: document.getElementById('group_body_3'),
    data: {count: 0, summa: 0, elements: []}
}
const Group4 = {
    dom: document.getElementById('group_body_4'),
    data: {count: 0, summa: 0, elements: []}
}
...
let info_group3 = document.getElementById('info_group_3')
let info_group4 = document.getElementById('info_group_4')
...
function define_groups_leads() {
    ...
    lead_card.forEach((one) => {
        ...
        switch (one.parentNode.id) {
            ...
            case "group_body_3":
                Group3.data.count += 1
                Group3.data.summa += obj.price
                Group3.data.elements.push(obj)
                break
            case "group_body_4":
                Group4.data.count += 1
                Group4.data.summa += obj.price
                Group4.data.elements.push(obj)
                break
        }
    })
    update_info_labels()
...
function update_info_labels() {
    ...
    info_group3.innerHTML = `${Group3.data.count} ta mijoz: $${thousand_separator(Group3.data.summa)}`
    info_group4.innerHTML = `${Group4.data.count} ta mijoz: $${thousand_separator(Group4.data.summa)}`
}
